...
public class CovidActivity extends AppCompatActivity {
    ...
    AppCompatButton btnProfile, btnHome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnProfile.setOnClickListener(v -> {
            Intent nav_to_profile = new Intent(CovidActivity.this, ProfileActivity.class);
        ...
        btnHome.setOnClickListener(v -> {
            Intent nav_to_home = new Intent(CovidActivity.this, MainActivity.class);
